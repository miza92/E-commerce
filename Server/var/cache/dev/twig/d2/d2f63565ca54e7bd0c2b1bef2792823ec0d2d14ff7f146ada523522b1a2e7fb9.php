...
/* user/show.html.twig */
class __TwigTemplate_627f37bada378cde0523ea9f14c7aa649dc8fb0c195602db9fa43e72996069f8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 28, $this->source); })()), "adress", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Telephone</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 36
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 36, $this->source); })()), "fixedDeliveryPrice", [], "any", false, false, false, 36)) ? ("Yes") : ("No"));
        echo "</td>
            </tr>
            <tr>
                <th>Password</th>
...
{% endblock %}
", "user/show.html.twig", "/home/miri/Rendu/semestre_2/w2web502p2/E-commerce/Server/templates/user/show.html.twig");
    }
}

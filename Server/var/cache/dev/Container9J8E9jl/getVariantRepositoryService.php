...
// Returns the private 'App\Repository\VariantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VariantRepository.php';

return $this->privates['App\\Repository\\VariantRepository'] = new \App\Repository\VariantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

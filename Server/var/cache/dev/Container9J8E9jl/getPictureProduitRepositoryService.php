...
// Returns the private 'App\Repository\PictureProduitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PictureProduitRepository.php';

return $this->privates['App\\Repository\\PictureProduitRepository'] = new \App\Repository\PictureProduitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

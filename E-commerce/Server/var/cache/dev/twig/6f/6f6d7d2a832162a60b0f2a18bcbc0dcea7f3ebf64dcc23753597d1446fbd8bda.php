...
class __TwigTemplate_652bd7ba38931251fbe9995740bbbe10e9e8376d0f26669b320ed7a280a41700 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table width=60% border=1 class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "\">edit</a>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("article_index", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">Filtrer</a>
                </td>
            </tr>
        ";
...
{% block body %}
        ...
        {% for category in categories %}
            <tr>
                ...
                <td>
                    ...
                    <a href=\"{{ path('article_index',  {'id': category.id}  ) }}\">Filtrer</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <br> 
{% endblock %}
", "category/index.html.twig", "/home/miri/Rendu/semestre_2/w2web502p2/E-commerce/Server/templates/category/index.html.twig");
    }
}

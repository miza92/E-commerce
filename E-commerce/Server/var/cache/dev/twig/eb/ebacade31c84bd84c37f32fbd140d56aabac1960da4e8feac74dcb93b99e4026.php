...
class __TwigTemplate_bc0c8cb3869306cae107ad9cf583778d46020f7142949de4d2653ddc302b37ab extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 29
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "adress", [], "any", false, false, false, 29), "html", null, true);
            echo "</td>
                <td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "telephone", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>
                <td>";
            // line 31
            echo ((twig_get_attribute($this->env, $this->source, $context["user"], "fixedDeliveryPrice", [], "any", false, false, false, 31)) ? ("Yes") : ("No"));
            echo "</td>
                <td>";
            // line 32
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "password", [], "any", false, false, false, 32), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 34
    ...
    <table class=\"table\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>{{ user.fixedDeliveryPrice ? 'Yes' : 'No' }}</td>
                <td>{{ user.password }}</td>
                <td>
...
{% endblock %}
", "user/index.html.twig", "/home/miri/Rendu/semestre_2/w2web502p2/E-commerce/Server/templates/user/index.html.twig");
    }
}
